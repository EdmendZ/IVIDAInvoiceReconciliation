...
const labels: Record<string, string> = {
  ...
  receive_only: "仅收货单存在", upload: "上传", taptouch: "TapTouch",
  automatic: "自动", manual: "手动", extracted: "提取", upstream: "上游",
  ...
  processing: "处理中", failed: "处理失败", cancelled: "已取消", voided: "已作废",
  waiting_counterpart: "等待另一方单据", needs_attention: "待核实",
  awaiting_confirmation: "待确认", completed: "已完成", ready: "就绪",
  equal: "一致", different: "不一致", unverified: "未核验",
  consistent: "商品明细一致", difference: "存在差异",
  blocked: "无法确认", matched: "已匹配", resolved_with_note: "已按说明处理",
  quantity_only: "仅核验数量", quantity_and_price: "核验数量和单价",
  quantity_and_amount: "核验数量和金额", full: "完整核验",
  document_total: "单据总额", tax: "税额", price: "单价", amount: "金额",
  supplier: "供应商", currency: "币种", scope: "范围",
  EMPTY_ITEM_KEY: "商品标识缺失", UNIT_UNVERIFIED: "单位未核验",
  UNIT_CONFLICT: "单位不一致", SUPPLIER_UNVERIFIED: "供应商未核验",
  SUPPLIER_CONFLICT: "供应商冲突", CURRENCY_CONFLICT: "币种不一致",
  UNSUPPORTED_CURRENCY: "币种暂不支持", SOURCE_VOIDED: "来源已作废",
  VALIDATION_BLOCKED: "单据校验未通过", DUPLICATE_INVOICE: "发票重复",
  RECEIVING_IN_USE: "收货单已被其他发票占用",
  PO_MATCH: "采购订单一致", PO_CONFLICT: "采购订单冲突",
  SUPPLIER_MATCH: "供应商一致", CURRENCY_MATCH: "币种一致",
  DATE_NEAR: "日期接近", DATE_MISSING: "日期缺失",
  DATE_OUTSIDE_WINDOW: "日期超出范围", ITEM_OVERLAP: "商品有交集",
  NO_ITEM_OVERLAP: "商品无交集", SELECTION_CHANGED: "关联收货已变更",
  INVESTIGATING: "开始核查", CONFIRMED: "已确认", REOPENED: "已重开",
  SOURCE_UPDATED: "来源已更新", RETRY_REQUESTED: "已请求重试",
};
...
const messages: Record<string, string> = {
  ...
  "Please acknowledge all sources and unverified dimensions": "请确认全部来源和未核验维度",
  "Please provide a resolution note": "请按核对结果填写处理说明",
};
